...
exports.explorecategories = async (req, res) => {
  try {
    ...
    res.render("categories", { title: "cooking blog-Catgories", categories });
  } catch (error) {
    res.status(500).send({ message: error.message } || "Error Ocurred");
  }
};
...
//   try {
//     const res=await Recipe.updateOne({name:'Panner'},{name:'Panneer'});
...
//   try {
//     await Recipe.deleteOne({name:'Panneer'});
//   } catch (error) {
//     console.log(error)
//   }
// }
